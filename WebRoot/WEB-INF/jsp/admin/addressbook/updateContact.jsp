...
<body>
	<table align="center">
		...
		<s:form id="updateContactForm" action="/admin/addressbook/updateContact.jspx" method="post" theme="simple">
			...
			<tr>
				<td>生日：</td>
				<td>
					<s:date name="contact.birthday" format="yyyy-MM-dd" var="birthday"/>
					<s:textfield name="contact.birthday" value="%{birthday}" cssClass="Wdate" 
