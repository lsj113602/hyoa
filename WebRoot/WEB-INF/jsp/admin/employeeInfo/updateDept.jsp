...
<body>
	<table align="center">
		...
		<s:form id="updateDeptForm" action="/admin/employeeInfo/updateDept.jspx" method="post" theme="simple">
			<!-- 防表单重复提交需要传的参数 -->
			<s:token></s:token>
			<tr>
				<td>部门id：</td>
				<td>
					<s:textfield name="dept.id" size="40" id="id" disabled="true"/>
				</td>
			</tr>
			<tr>
				<td>部门名称：</td>
				<td>
					...
					<s:textfield name="dept.name" size="40" id="name"/>
				</td>
			</tr>
			<tr>
				<td>部门备注：</td>
				<td>
					<s:textarea name="dept.remark" rows="3" cols="38" id="remark"/>
				</td>
			</tr>
			<tr>
